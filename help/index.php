...
if(isset($_SESSION['bitex_sessionid']) && isset($_SESSION['user_id']) && $_SESSION['bitex_sessionid'] === md5($_SESSION['user_id'])) {
    $user_login = true;
    insert_user_action($_SESSION['ip_address'],$_SESSION['user_id'],'ورود به راهنما',$_SESSION['bitex_username']);
}
?>
<!DOCTYPE html>
                    ...
                    <div class="uk-card-header">
                        <div class="uk-grid-small uk-flex-middle" uk-grid>
                            ...
                            <div class="uk-width-expand">
                                <h3 class="uk-card-title uk-margin-remove-bottom calculate-title">راهنما</h3>
                            </div>
                        </div>
                    </div>
                    <div class="uk-card-body">
                        <p class="shabnam">این صفحه در حال به روز رسانی می باشد. به زودی راهنمای استفاده از خدمات سامانه و مطالب آموزشی متنوع در حوزه ارز های دیجیتال و بازارهای مالی در این صفحه منتشر خواهد شد.
                        </p>
                    </div>
                </div>
