...
(function(b, a, c) {
    ...
    b.extend(!0, g.defaults, {
        dom: "<'row uk-grid'<'uk-width-1-2'f><'uk-width-1-2 uk-text-left'l>><'row uk-grid dt-merge-grid'<'uk-width-1-1'tr>><'row uk-grid dt-merge-grid'<'uk-width-3-5'p><'uk-width-2-5 uk-text-left'i>>",
        renderer: "uikit"
    });
    ...
    g.ext.renderer.pageButton.uikit = function(a, h, r, m, j, n) {
                    ...
                    if (e = g[l], b.isArray(e)) q(c, e);
                        ...
                        switch (e) {
                            ...
                            case "first":
                                ...
                                break;
                            case "previous":
                                f = '<span uk-pagination-previous></span> ' + k.sPrevious;
                                d = 0 < j ? "" : "uk-disabled disabled";
                                break;
                            case "next":
                                f = k.sNext + ' <span uk-pagination-next></span>';
        ...
        q(b(h).empty().html('<ul class="uk-pagination"/>').children("ul"),
            m);
