...
if(isset($_SESSION['bitex_sessionid']) && isset($_SESSION['user_id']) && $_SESSION['bitex_sessionid'] === md5($_SESSION['user_id'])) {
    $user_login = true; 
    insert_user_action($_SESSION['ip_address'],$_SESSION['user_id'],'ورود به درباره ما',$_SESSION['bitex_username']);
}
?>
<!DOCTYPE html>
                    ...
                    <div class="uk-card-header">
                        <div class="uk-grid-small uk-flex-middle" uk-grid>
                            <div class="uk-width-auto">
                                <img width="64" height="64" src="<?php echo $root_path; ?>asset/img/aboutus.png">
                            </div>
                            <div class="uk-width-expand">
                                <h3 class="uk-card-title uk-margin-remove-bottom calculate-title">درباره ما</h3>
                            </div>
                        </div>
                    </div>
                    <div class="uk-card-body">
                        <p class="shabnam">خدمات ارز دیجیتال آسان یک سامانه تحت وب می باشد که در حوزه خدمات رمزارزها فعالیت می نماید.تلاش این مجموعه در ارائه بهترین نرخ خدمات در سریعترین زمان ممکن می باشد.</p>
                        <p class="shabnam">
                            این مجموعه سعی دارد با استفاده از توان متخصصین خود راهکارهای جدید در ارائه خدمات مالی مبتنی بر تکنولوژی بلاکچین ، الگوریتم های معاملاتی و هوش مصنوعی ارائه نماید.
                        </p>
                    </div>
                </div>
